...
*/
class DisableBillingFieldsRepeater
{
	private $repo;

	public function __construct()
	{
		$this->repo = new DisableBillingFieldsRepository;
		add_filter( 'woocommerce_generate_repeater_disable_billing_fields_html', [$this, 'field'], 10, 4 );
	}
	...
	public function field($output, $key, $data, $method)
	{
		...
		<tr valign="top">
			...
			<td class="forminp">
				...
				<a href="#" data-woocommerce-invoice-payment-repeater-add-new="disable_billing_fields" class="button">
